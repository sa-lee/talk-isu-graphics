...
```{r, echo = FALSE}
library(vembedr)
use_align(embed_vimeo("439635812", width = 800), align = "center")
```
...
# WIP: `virgo` for interactive graphics in R
...
* Much of design space for interactivity is still up for grabs!
