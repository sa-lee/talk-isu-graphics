...
date: "<span style = 'font-size: 90%;'>ISU Graphics Seminar<br><br> Thursday 15th October, 2020 </span> <br><br>"
output:
...
.vhuge[[https://bit.ly/314AG23](https://bit.ly/314AG23)]
...
* Developments in interactive graphics with R
]
...
# t-SNE is state of the art, but how can we help analysts understand it?
...
- treats the basis generation/interpolation steps as a reactive stream in `shiny` 
]
...
background-image: url(img/multiple-shadows.jpg)
...
include_graphics("img/jm-interactive.png")
```

.medium[(from __McDonald (1982)__)]
...
# The surprising effectiveness of linked brushing
...
use_bs_responsive(
  use_align(
    embed_vimeo("439635812", width = 800, height = 600), 
    align = "center"
  )
)
```
...
.large[
- **code complexity** of interactive graphics
...
# `virgo` for interactive graphics in R

## Joint work with [Earo Wang](earo.wang)

---

class: middle center

# Demo 5: interactive graphics with `virgo`
...
`r icon::fa('link')` [talk link](https://bit.ly/314AG23)
]
